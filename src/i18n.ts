  ...
  en: {
    translation: {
      ...
      luaCode: {
        ...
        overrun: 'Generated code was too long, so it was split into multiple Lua blocks.',
        colorSplit: 'Some color commands were also split.',
      },
      basic: {
        rollsignMode: 'Rollsign mode',
        rollsignBefore: '',
        rollsignAfter: ' output is generated. Some settings below are disabled.',
        gap: 'Gap between cards',
        warning32: 'If clip height + gap is not 32, you need to modify the Selector microcontroller Lua code.',
  ...
  ja: {
    translation: {
      ...
      basic: {
        ...
        rollsignBefore: '',
        rollsignAfter: '用の変換結果を出力します。以下の一部設定は無効となります。',
        gap: '幕の間隔',
        warning32: '切り抜き高さ+幕間の隙間が32以外になるときは、SelectorマイコンのLuaコードを改造する必要があります。',
